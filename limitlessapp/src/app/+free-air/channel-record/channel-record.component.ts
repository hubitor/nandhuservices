...
@Component({
  ...
  export class ChannelRecordComponent {
    ...
    startRecording()
    {
      ...
      // console.log("http://live.haappyapp.com:8086/livestreamrecord?app=" +channelrequest.w_application_name+ "&streamname="+channelrequest.ch_stream_name+"&action=startRecording");
      // return "http://live.haappyapp.com:8086/livestreamrecord?app=" +channelrequest.w_application_name+ "&streamname="+channelrequest.ch_stream_name+"&action=startRecording";
    ...
    { 
      ...
      // console.log("http://live.haappyapp.com:8086/livestreamrecord?app=" +channelrequest.w_application_name+ "&streamname="+channelrequest.ch_stream_name+"&action=stopRecording");      
      // return "http://live.haappyapp.com:8086/livestreamrecord?app=" + channelrequest.w_application_name+ "&streamname="+channelrequest.ch_stream_name+"&action=stopRecording"
                       ...
                       if(response.instanceList[0].incomingStreams.length>0)
                       {
                           ...
                           incomingStreams.forEach((ics) => { // foreach statement 
                            ...
                            if(ics.isConnected)
                            {
                                ...
                                this.finalUrl = v_url;
                                channelrequest.thumbnailUrl = this.formatThumbnailURL(w_appl_name,channelrequest.ch_stream_name);
